 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 396.51 } // default steps per unit for Ulimaker
...
// #define BLTOUCH
// #if ENABLED(BLTOUCH)
//   #define BLTOUCH_DELAY 100   // (ms) Enable and increase if needed (original 375)
// #endif
...
//
// #define Z_CLEARANCE_DEPLOY_PROBE 15 // Z Clearance for Deploy/Stow : set up at least 5
// #define Z_CLEARANCE_BETWEEN_PROBES 5  // Z Clearance between probe points : set up at least 5
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 271 // (300 - 29), accounting for the side fans
